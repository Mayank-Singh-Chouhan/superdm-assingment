...
const WorkspaceTemplate = () => {
    ...
    return (
        <div className="h-[90vh] w-[90vw] backdrop-blur-[19px] rounded-xl border border-fs-border bg-fs-background backdrop-saturate-[180%] flex flex-col overflow-hidden p-4" >
